...
vect3 SO3ToEuler(const SO3 &orient) 
{
	...
	if (test > 0.49999*unit) { // singularity at north pole
		...
		double temp[3] = {_ang[0], _ang[1], _ang[2]};//弧度
...
{	
	Eigen::AngleAxisd rollAngle(Eigen::AngleAxisd(euler_ang(0),Eigen::Vector3d::UnitX()));
	Eigen::AngleAxisd pitchAngle(Eigen::AngleAxisd(euler_ang(1),Eigen::Vector3d::UnitY()));
	Eigen::AngleAxisd yawAngle(Eigen::AngleAxisd(euler_ang(2),Eigen::Vector3d::UnitZ()));
