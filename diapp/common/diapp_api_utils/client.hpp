...
#ifndef DIAPP_API_UTILS__RCLCPP__CLIENT_HPP_
#define DIAPP_API_UTILS__RCLCPP__CLIENT_HPP_

#include "rclcpp/client.hpp"
#include "diapp_api_utils/types/response.hpp"

#include <chrono>
#include <utility>

namespace diapp_api_utils
{
...
public:
  ...
  using ResponseStatus = diapp_external_api_msgs::msg::ResponseStatus;
  using DiappServiceResult = std::pair<ResponseStatus, typename ServiceT::Response::SharedPtr>;
...
#endif  // DIAPP_API_UTILS__RCLCPP__CLIENT_HPP_
